...
'URL to open....
sUrl = "http://172.16.98.151:8488/register"

'POST Request to send.
sRequest = "employee_number=" & CreateObject("WScript.Network").UserName
...
Dim strPort 
strPort = HTTPPost(sUrl, sRequest)
' Wscript.Echo strPort
...
' Configuration
Dim strHost, strUrl, strCD, intSleep
strHost = "172.16.98.151"
intSleep = 5000
